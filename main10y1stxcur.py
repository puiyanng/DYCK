...
def start():
    ...
    #data["Order"] = np.arange(len(data)) +  1
    drop_cols = ['RUSS_Close', 'NYSE_Close', 'NASDAQ_Close', 'N225_Close', 'USDCNY_Close', 'USDEUR_Close', 'USDGBP_Close', 'USDJPY_Close']
    data = data.drop(drop_cols, axis=1)
    print("Only: " + ', '.join(data.columns))
    # print(data)
    ...
    if True:
        ...
        xTrain_fnn, xTest_fnn, yTrain_fnn, yTest_fnn = xTrain, xTest, yTrain, yTest
